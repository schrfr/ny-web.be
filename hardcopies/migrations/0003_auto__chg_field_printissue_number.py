...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PrintIssue.number'
        db.alter_column('hardcopies_printissue', 'number', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=3, null=True))
    ...
    models = {
        ...
        'hardcopies.printissue': {
            ...
            'number': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),
