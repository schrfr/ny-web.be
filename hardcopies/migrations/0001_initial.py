...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hardcopies_magazine', (
        ...
        db.send_create_signal('hardcopies', ['Magazine'])

        # Adding model 'PrintIssue'
        db.create_table('hardcopies_printissue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('number', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=3, null=True, blank=True)),
            ('pub_date', self.gf('django.db.models.fields.DateField')()),
            ('cover', self.gf('filebrowser.fields.FileBrowseField')(max_length=200)),
            ('identifier', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
            ('summary', self.gf('tinymce.models.HTMLField')(blank=True)),
        ))
        db.send_create_signal('hardcopies', ['PrintIssue'])

        # Adding model 'PrintIssueOnlineText'
        db.create_table('hardcopies_printissueonlinetext', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('print_issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hardcopies.PrintIssue'])),
            ('online_text', self.gf('django.db.models.fields.related.ForeignKey')(related_name='print_issues', to=orm['library.Text'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('hardcopies', ['PrintIssueOnlineText'])


    def backwards(self, orm):
        # Deleting model 'Magazine'
        db.delete_table('hardcopies_magazine')

        # Deleting model 'PrintIssue'
        db.delete_table('hardcopies_printissue')

        # Deleting model 'PrintIssueOnlineText'
        db.delete_table('hardcopies_printissueonlinetext')
